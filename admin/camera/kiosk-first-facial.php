...
if ($rfid_no) {
    ...
    if (sqlsrv_has_rows($stmt)) {
        ...
        $type = "error";
        header("Location: ../pages/admin-upload-face.php?rfid_no=" . urlencode($rfid_no) . "&message=" . urlencode($message) . "&type=" . urlencode($type));
        exit();
    }
    ...
    $type = "error";
    header("Location: ../pages/admin-upload-face.php?message=" . urlencode($message) . "&type=" . urlencode($type));
    exit();
}
    ...
    <div id="body-container">
      ...
      <!--div id="top-right-button">
        ...
        <div id="top-left-button">
            <a href="../pages/admin-upload-face.php?rfid_no=<?php echo urlencode($rfid_no); ?>" class="no-underline">
