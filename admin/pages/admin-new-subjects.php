...
<body>
    ...
    <div id="main-content" class="main-content">
        <form id="uploadForm" action="../functions/insert-subjects.php" method="POST" enctype="multipart/form-data">
            <div class="action-widgets-2">
                <div class="widget-button">
                    <h1 class="sub-title">Subject / New </h1>
                    <div class="buttons">
                ...
                <div class="faculty-container-2">
                    ...
                    <div class="faculty-name-container">
                        <div>
                            ...
                            <input class="name-input" type="text" id="subject_code" name="subject_code" required>
                        </div>
                        <div>
