...
<body class="fade-out">
    ...
    <div id="body-container">
        ...
        <div class="r-container">
            <h1>Reminder!</h1>
            <p>Follow reminders to set up facial recognition.</p>
            <div class="r-images">
                <div class="r-image dont">
                    <img src="../../assets/images/dont_1.png" alt="Don't Example" class="dark-img">
            ...
            <div class="r-reminder">Reminder 1: Take a selfie in a well lit area</div>
            <div class="r-description">Not too bright, not too dark.</div>
            <div class="indicator">
      ...
      <!--div id="top-right-button">
        ...
        <div id="top-left-button">
            <a href="kiosk-first-facial.php?rfid_no=<?php echo urlencode($rfid_no); ?>" class="no-underline">
