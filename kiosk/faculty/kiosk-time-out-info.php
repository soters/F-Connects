...
try {
    ...
    if ($result) {
        ...
        $timeOut = htmlspecialchars($result['time_out'] ? $result['time_out']->format('h:i A') : 'N/A', ENT_QUOTES, 'UTF-8');
...
<body class="fade-out">
    ...
    <div class="t-container">
        <div class="t-card">
            <h2 class="t-main-message">Confirm Time Out</h2>
            <p class="t-sub-message">Time Out to end the work for the day</p>
