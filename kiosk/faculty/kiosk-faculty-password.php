    ...
    <div id="modal-overlay"
        ...
        <div id="modal-container"
            ...
            <div
                ...
                <h2 style="margin: 0; font-weight: 600; font-size: 2em;">YOU'RE ALMOST THERE</h2>
                <p style="margin: 10px 0 0; opacity: 0.9; font-size: 1.2em;">Please enter your password to continue</p>
            </div>

            <!-- Modal Body -->
            <div style="padding: 35px;">
                <form id="student-form" method="POST" action="../functions/check-password.php">
                    <div style="margin-bottom: 35px;">
                        <label
                            style="display: block; margin-bottom: 15px; color: #34495e; font-weight: 500; font-size: 1.3em;">PASSWORD</label>
                        <div style="position: relative; margin-bottom: 10px;">
                            ...
                            <input type="hidden" name="rfid_no" value="<?= htmlspecialchars($rfid_no) ?>">
            ...
            document.querySelectorAll('.keyboard-special').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    switch (action) {
                        case 'backspace':
                            if (startPos > 0) {
                                currentInput.value = currentValue.substring(0, startPos - 1) + currentValue.substring(startPos);
                                currentInput.setSelectionRange(startPos - 1, startPos - 1);
                            }
                            break;
                        case 'space':
                            currentInput.value = currentValue.substring(0, startPos) + ' ' + currentValue.substring(startPos);
                            currentInput.setSelectionRange(startPos + 1, startPos + 1);
                            break;
                        case 'enter':
