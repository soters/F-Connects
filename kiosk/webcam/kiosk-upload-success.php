...
<body class="fade-out">
    ...
    <div id="body-container">
        ...
        <p id="action-message-small">You can now use facial recognition for attendance verification</p>
        <br>
        <div class="action-box-s">
            <a href="../faculty/kiosk-detect-face.php?rfid_no=<?php echo $rfid_no; ?>" class="no-underline">
